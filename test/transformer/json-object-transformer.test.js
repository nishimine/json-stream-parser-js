...
describe('JsonObjectTransformer (Integration)', () => {
    ...
    describe('ネストしたオブジェクト', () => {
        ...
        test('空と非空のネストが混在', async () => {
            ...
            expect(results).toHaveLength(1);
            expect(results[0]).toEqual({ path: '$.data.value', value: 123 });
        });
    });
